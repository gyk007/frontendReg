		...
		<section class="catalog__products-holder">
			<div class="catalog__products-scroll jq-scroll">
				...
				<div class="catalog__products-row js-t-row" v-on:click="getProduct(product)" v-for="product in productList">
						...
						<div class="catalog__products-col catalog__products-btn"><a data-fancybox data-src="#popup__product" href="javascript:;" class="btn btn--reject" v-on:click="editProduct(product)">Редактировать</a></div>
				</div>
