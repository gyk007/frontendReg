<template>
	...
	<div class="popup__hdr" v-if="product.name">Редактировать продутк</div>
	...
	<div class="popup__category-form">
		...
		<div class="popup__product-form--holder" v-for="prop in product.properties">
		<label>
			<span style="font-size: 15px">{{prop.name}} <span v-if="prop.name == 'Price'" class="product_prop_value">&#8381;</span></span>
		...
		<button class="btn" v-on:click="editProduct" v-if="product.name">Редактировать</button>
